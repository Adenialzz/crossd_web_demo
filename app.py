...
def upload():
    ...
    if request.method == "POST":
        ...
        cv_model.run(upload_image_path)
        ...
        return render_template("upload_ok.html", input_image_path=input_image_path, top10_paths_dict=top10_paths_dict, val1 = time.time())
