...
from TopK_Matched_Retriever import TopKTagsRetriever
...
class CrossDModel(BaseCVServiceModel):
    ...
    def load_tags_file(self):
        # init self.iamges_list and self.feats_2d
    ...
    def run(self, image_path):
        ...
        # tags_retriever = TopK_Matched_Retriever('crossd_evaluation/ret_original3d.json')
        # srt_topk = tags_retriever.extract_topk_matched(osp.basename(image_path), K)
...
if __name__ == '__main__':
    ...
    # model = CrossDModel( base_out_dir='res_query/', lib2d_tags_file='all_2d_tags.json', lib2d_feats_file='all_2d_images.json', lib2d_images_dir="", tags_thr=0.3 )
    model = CrossDModel( base_out_dir='res_query/', lib2d_tags_file='lib2d/lib2d_tags.json', lib2d_feats_file='lib2d/lib2d_feats.json', lib2d_images_dir='lib2d/lib2d_1000_images', tags_thr=0.3, tags_k=3 )
